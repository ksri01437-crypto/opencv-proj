...
2. **🖱️ REAL COMPUTER MOUSE CONTROL (`/mouse`)**: Direct laptop OS cursor control using PyAutoGUI. Move real OS mouse with index finger, left click / drag with pinch, right click with peace sign (2 fingers), and toggle mouse control with a fist.
...
|---|---|---|
| **Aim / Move Cursor** | ☝ Point Index Finger | Game & Real Mouse |
| **Slice Fruits** | ✋ Fast Hand Swipe | Game |
| **Left Click / Select** | 👌 Pinch (Thumb + Index Tip) | Game & Real Mouse |
| **Drag & Drop** | 👌 Hold Pinch | Real Mouse |
| **Right Click** | ✌️ Peace Sign (2 Fingers Extended) | Real Mouse |
| **Pause / Toggle Control** | ✊ Make a Fist | Game & Real Mouse |
| **Neutral Navigation** | 🖐️ Open Palm | Game & Real Mouse |
